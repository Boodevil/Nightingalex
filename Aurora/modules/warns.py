...
import telegram
from Aurora import TIGERS, WOLVES, dispatcher
...
from Aurora.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Aurora.modules.helper_funcs.string_handling import split_quotes
from Aurora.modules.log_channel import loggable
from Aurora.modules.sql import warns_sql as sql
...
from Aurora.modules.sql.approve_sql import is_approved
