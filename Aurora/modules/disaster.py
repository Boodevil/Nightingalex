...
def supportlist(update: Update, context: CallbackContext):
    bot = context.bot
    reply = "<b>Known Vice admiral ❄️:</b>\n"
...
WHITELISTLIST_HANDLER = CommandHandler(["rearadmirals"],
                                       whitelistlist)
TIGERLIST_HANDLER = CommandHandler(["bottoms"], tigerlist)
SUPPORTLIST_HANDLER = CommandHandler(["viceadmirals"], supportlist)
SUDOLIST_HANDLER = CommandHandler(["admirals"], sudolist)
DEVLIST_HANDLER = CommandHandler(["fleetadmirals"], devlist)
...
Visit @telegram.org for more information. """
